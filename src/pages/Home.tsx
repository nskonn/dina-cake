...
export function Home() {
    ...
    const products = [
        ...
        },
        {
            ...
            price: '150 ₽/шт',
            image: 'https://images.unsplash.com/photo-1606939279993-2a51faa8be74?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYWNhcm9uc3xlbnwxfHx8fDE3NjI2MTU3NDR8MA&ixlib=rb-4.1.0&q=80&w=1080',
        },
    ];
    ...
    const recentWorks = [
        {
            ...
            image: 'https://images.unsplash.com/photo-1535254973040-607b474cb50d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwY2FrZXxlbnwxfHx8fDE3NjI1OTQzMjZ8MA&ixlib=rb-4.1.0&q=80&w=1080',
            description: 'Трехъярусный торт с живыми цветами и кремовыми розами',
        },
        {
        ...
        },
        {
            ...
            description: 'Легкий бисквит со свежей клубникой и сливочным кремом',
        },
        {
            cakeName: 'Набор капкейков',
            image: 'https://images.unsplash.com/photo-1486427944299-d1955d23e34d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjdXBjYWtlc3xlbnwxfHx8fDE3NjI3MTE4MzF8MA&ixlib=rb-4.1.0&q=80&w=1080',
            description: 'Ассорти капкейков для корпоративного мероприятия',
        },
        {
            ...
            <section className="py-20 bg-[#F5E8DC]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex gap-6 mb-8 overflow-x-auto pb-2 scrollbar-hide border-b border-gray-300">
                        {['Торты', 'Бенто-торты', 'Капкейки', 'Трайфл'].map(category => (
                            <button
                                key={category}
                                onClick={() => {
                        ...
                        {[
                            {
                                ...
                                price: '2 900 р.',
                                image: 'https://images.unsplash.com/photo-1543509338-c6faf7aeb69c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3aGl0ZSUyMGNyZWFtJTIwY2FrZXxlbnwxfHx8fDE3NjI3MTUwNDR8MA&ixlib=rb-4.1.0&q=80&w=1080',
                                badge: 'Новинка',
                            },
                            {
                                name: '«Манго-кейк»',
                                ...
                                price: '4 100 р.',
                                image: 'https://images.unsplash.com/photo-1730672558646-c65c4784dd16?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx5ZWxsb3clMjBjYWtlJTIwZGVzc2VydHxlbnwxfHx8fDE3NjI3MTUwNDN8MA&ixlib=rb-4.1.0&q=80&w=1080',
                                badge: 'Сезонное',
                            },
                            {
                                ...
                                price: '2 200 р.',
                                image: 'https://images.unsplash.com/photo-1761637604976-40612bc4544c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjaG9jb2xhdGUlMjBjYWtlJTIwcm91bmR8ZW58MXx8fHwxNzYyNzE1MDQzfDA&ixlib=rb-4.1.0&q=80&w=1080',
                                badge: 'Новинка',
                            },
                        ].map((product, index) => (
                            <div
                                ...
                                <div>
                                    ...
                                    <div className="mt-4 pt-4 border-t border-white/20">
                                        <p className="text-sm opacity-90">
                                            Чем раньше вы оформите заказ, тем больше возможностей
