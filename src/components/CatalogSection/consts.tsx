...
export const CATEGORY_INFO = {
    ...
    [CatalogCategory.Cupcakes]: {
        title: 'Капкейки',
        description:
            'Порционные мини-тортики с начинкой внутри и пышной шапочкой из крема. Удобный формат для фуршетов, праздников и корпоративных мероприятий.',
        specs: [
            {
                icon: Box,
                label: 'Заказ',
    ...
    [CatalogCategory.Eskimo]: {
        ...
        description:
            'Оригинальное пирожное в форме мороженого на палочке. Внутри — пирожное «картошка» с нежной начинкой, снаружи — хрустящее шоколадное покрытие.',
        specs: [
            {
                icon: Box,
                label: 'Заказ',
